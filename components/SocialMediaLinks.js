...
export default function SocialMediaLinks() {
  return (
    <div className="flex items-center justify-center space-x-3">
      ...
      {/* GitHub */}
      {/* <a
        href="https://github.com/devdossier"
        target="_blank"
        rel="noopener noreferrer"
        className="relative p-2 rounded-xl text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-900/30 transition-all duration-300 hover:scale-110 hover:rotate-6 group backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-gray-500/20"
      >
        <svg
          className="w-5 h-5 group-hover:animate-bounce"
          fill="currentColor"
      ...
      >
        <svg
          className="w-5 h-5 animate-pulse group-hover:animate-none"
          fill="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="relative p-2 rounded-xl text-gray-600 hover:text-re-300 dark:hover:text-red-500 hover:bg-red-100 dark:hover:bg-red-900/30 transition-all duration-300 hover:scale-110 hover:-rotate-6 group backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-red-500/20"
      >
        <svg
